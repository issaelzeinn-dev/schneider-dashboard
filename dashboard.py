...
def load():
    ...
    d["cfo_ebt"] = [c/e if e else None for c,e in zip(d["cfo"], d["ebita"])]
...
with tabs[4]:
    ...
    ratio_table([
        ...
        ["CFO / EBITA",      *[safe(v,'x')   for v in reversed(d['cfo_ebt'])], sig(d['cfo_ebt'][4],0.70,0.50)],
        ...
        if submitted:
            if inp_revenue <= 0:
                ...
                _entry = {
                    ...
                    "cfo_ebt":     inp_cfo / inp_ebita  if inp_ebita  else None,
